...
extension DetailViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        guard let detailCell = collectionView.dequeueReusableCell(withReuseIdentifier: FifthTabCollectionViewCell.identifier, for: indexPath) as? FifthTabCollectionViewCell else { return UICollectionViewCell() }
